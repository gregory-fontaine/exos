...
echo PHP_EOL;
$variableUne = 'Gregory';
$variableDeux = 'Fontaine';

echo $variableUne.' '.$variableDeux.PHP_EOL;

$variableInterpolation = "Bonjour mon nom est $variableDeux et mon prénom est $variableUne";

echo $variableInterpolation;